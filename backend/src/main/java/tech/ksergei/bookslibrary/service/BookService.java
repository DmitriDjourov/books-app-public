...
import tech.ksergei.bookslibrary.dao.BookRepository;
import tech.ksergei.bookslibrary.dao.CheckoutRepository;
import tech.ksergei.bookslibrary.dao.HistoryRepository;
import tech.ksergei.bookslibrary.entity.Book;
import tech.ksergei.bookslibrary.entity.Checkout;
...
public class BookService {
  ...
  public Book checkoutBook(String userEmail, Long bookId) throws Exception {
    ...
    if (!book.isPresent() || validateCheckout != null || book.get().getCopiesAvailable() <= 0) {
      throw new Exception("Отзыв уже написан");
    }
  ...
  public void renewLoan(String userEmail, Long bookId) throws Exception {
    ...
    if (d1.compareTo(d2) > 0 || d1.compareTo(d2) == 0) {
      validateCheckout.setReturnDate(LocalDate.now().plusDays(3).toString());
