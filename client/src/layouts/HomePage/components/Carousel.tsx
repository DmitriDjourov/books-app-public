...
function Carousel() {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      ...
      const responseData = (await response.json())._embedded.books;
  ...
  return (
    <div className="container mt-3 carousel-container">
      ...
      <div className="homepage-carousel-title mt-2">
        <Link className="btn btn-outline-secondary btn-lg" to="/">Подробности</Link>
      </div>
    </div>
  );
}
